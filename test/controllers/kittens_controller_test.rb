...
class KittensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kitten" do
    assert_difference('Kitten.count') do
      post kittens_url, params: { kitten: { cuteness: @kitten.cuteness, explodes: @kitten.explodes, name: @kitten.name, owner: @kitten.owner } }, as: :json
    end
  ...
  test "should update kitten" do
    patch kitten_url(@kitten), params: { kitten: { cuteness: @kitten.cuteness, explodes: @kitten.explodes, name: @kitten.name, owner: @kitten.owner } }, as: :json
    assert_response 200
  end
