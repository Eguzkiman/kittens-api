...
class TurtlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turtle" do
    assert_difference('Turtle.count') do
      post turtles_url, params: { turtle: { color: @turtle.color, lives_on_fresh_water: @turtle.lives_on_fresh_water, name: @turtle.name, radius: @turtle.radius } }, as: :json
    end
  ...
  test "should update turtle" do
    patch turtle_url(@turtle), params: { turtle: { color: @turtle.color, lives_on_fresh_water: @turtle.lives_on_fresh_water, name: @turtle.name, radius: @turtle.radius } }, as: :json
    assert_response 200
  end
